...
const { editProyectState, editParteSemanal, getAllProducts, getAllTallers, getProyectsDone, getLastproyects, editarCantidadAProducir, editarCostoUnitario, eliminarProductoDelProyecto, agregarProductoAlProyecto, editarCantidadProducida, actualizarEgresos, actualizarObservaciones, removeInsumo, getProyectsPending, getProyectsDelayed, getCountProducts, getAllDbProducts, asignarProyecto } = require('../../../services/stockServices/stockServices');
